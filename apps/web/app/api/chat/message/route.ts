 ...
 * Note: Image generation is handled separately in the Images tab via /api/chat/image
 */
export async function POST(request: NextRequest) {
  try {
    ...
    // Note: Image generation is only available in the Images tab, not in chat messages
