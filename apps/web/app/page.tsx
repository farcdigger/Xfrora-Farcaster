    ...
    <div className="min-h-screen bg-white dark:bg-black">
      ...
      <nav className="bg-white dark:bg-black border-b border-gray-200 dark:border-gray-800 sticky top-0 z-50">
        <div className="max-w-7xl mx-auto px-2 sm:px-4 py-2">
          <div className="flex items-center justify-between gap-1.5 sm:gap-2 overflow-x-auto">
            {/* Logo */}
            <div className="flex items-center gap-1.5 sm:gap-2 flex-shrink-0">
              ...
              />
              <span className="text-base sm:text-xl font-bold text-gray-800 uppercase dark:text-slate-100 whitespace-nowrap">XFRORA</span>
            </div>
            ...
            <div className="flex items-center gap-1 sm:gap-1.5 flex-shrink-0">
              ...
              <button
                ...
                className="inline-flex items-center gap-1 rounded-full border border-gray-900/15 bg-white/70 px-2 py-1.5 text-[10px] sm:text-xs font-semibold text-gray-900 shadow-sm backdrop-blur transition-all hover:bg-white dark:border-white/30 dark:bg-white/10 dark:text-white"
                title="Chat"
              >
              ...
              {isInMiniApp ? (
                <button
                  ...
                  className="inline-flex items-center gap-1 rounded-full border border-gray-900/15 bg-white/70 px-2 py-1.5 text-[10px] sm:text-xs font-semibold text-gray-900 shadow-sm backdrop-blur transition-all hover:bg-white dark:border-white/30 dark:bg-white/10 dark:text-white whitespace-nowrap"
                >
              ...
              {farcasterUser ? (
                <div className="flex items-center gap-1 sm:gap-1.5 px-2 sm:px-2.5 py-1 bg-gray-100 dark:bg-gray-800 rounded-full border border-gray-200 dark:border-gray-700 flex-shrink-0">
                  {farcasterUser.pfp_url ? (
                    ...
                    <div className="w-5 h-5 sm:w-6 sm:h-6 rounded-full bg-purple-500 flex items-center justify-center text-white text-[10px] sm:text-xs font-bold flex-shrink-0">
                      {farcasterUser.username?.[0]?.toUpperCase() || "F"}
                    </div>
                  )}
                  <div className="flex items-center gap-1 flex-shrink-0 min-w-0">
                    <span className="text-[10px] sm:text-xs font-medium text-gray-900 dark:text-white truncate max-w-[80px] sm:max-w-none">
                      {farcasterUser.username ? `@${farcasterUser.username}` : farcasterUser.display_name || "Farcaster"}
                    </span>
                    {isConnected && address && (
                      <span className="text-[9px] sm:text-xs text-gray-500 dark:text-gray-400 flex-shrink-0">
                ...
                <div className="px-2 py-1 text-[10px] sm:text-xs bg-gray-100 dark:bg-gray-800 rounded-full border border-gray-200 dark:border-gray-700 text-gray-700 dark:text-gray-300 flex-shrink-0 whitespace-nowrap">
                  {address.substring(0, 4)}...{address.substring(address.length - 4)}
                </div>
              ) : null}
            </div>
