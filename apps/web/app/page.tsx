...
import DeepResearchWebOnlyModal from "@/components/DeepResearchWebOnlyModal";
...
function HomePageContent() {
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-black">
              ...
              <div className="relative">
                ...
                {menuOpen && (
                  <div className="absolute right-0 mt-2 w-56 rounded-2xl border border-gray-200/60 bg-white/95 shadow-2xl backdrop-blur dark:border-gray-800/80 dark:bg-gray-900/90 z-50">
                    ...
                    <div className="flex items-center justify-between px-4 py-3 border-b border-gray-100/70 dark:border-gray-800/80">
      ...
      {/* Deep Research Web Only Modal */}
      {showDeepResearchModal && (
        <DeepResearchWebOnlyModal
